...
function DashboardPage() {
  console.log('🚀 Super Admin Dashboard mounting with safe auth...');

  // Safe authentication hook with fallback
  let authState;
  try {
    authState = useSuperAdminAuth();
  } catch (error) {
    console.warn('Auth context error, using fallback state:', error);
    authState = {
  ...
  const { isAuthenticated, isLoading, superAdmin } = authState;
