# ============================================================================
# Runtime environment with WhatsApp Web API v1.4.0 (Downloaded from GitHub)
# ============================================================================
...
# Download and setup WhatsApp Web API v1.4.0 from GitHub releases (force fresh download)
RUN wget --no-cache https://github.com/rizrmd/whatsapp-web-api/releases/download/v1.4.0/whatsapp-web-api-linux-amd64.zip \
...
RUN chmod +x /usr/local/bin/whatsapp-web-api && \
    /usr/local/bin/whatsapp-web-api --version || echo "WhatsApp Web API v1.4.0 ready"
